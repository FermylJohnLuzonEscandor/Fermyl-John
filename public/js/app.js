...
class Component extends App{
    ...
    <div class="nav-wrapper">
      <a href="#" class="brand-logo">&nbsp&nbsp&nbspNICE KICKS</a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><a href="sass.html">About Us</a></li>
        <li><a href="badges.html">What's NEW</a></li>
        <li><a href="collapsible.html">Email Us</a></li>
      </ul>
    </div>
...
<div class="slider">
    <ul class="slides">
      <li>
        <img src="img/kobe0.jpg"> <!-- random image -->
      ...
      <li>
        <img src="img/kobe2.jpg"> <!-- random image -->
      ...
      <li>
        <img src="img/kobee.jpg"> <!-- random image -->
      ...
      <li>
        <img src="img/kobe1.jpg"> <!-- random image -->
        <div class="caption right-align">
          <h3>Right Aligned Caption</h3>
          <h5 class="light grey-text text-lighten-3">Here's our small slogan.</h5>
        </div>
   ...
   <div class="col s12 m7">
    ...
    <div class="card horizontal">
      <div class="card-image">
        <img src="img/kobe0.jpg">
      </div>
      <div class="card-stacked">
        <div class="card-content">
          <p class="black-text">Color: Cool Grey/Cool Grey-White
								<br>
